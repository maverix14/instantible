...
jQuery(function() {
    'use strict';
    var daftplugAdminMetabox = jQuery('.daftplugAdminMetabox');
    ...
    daftplugAdminMetabox.find('.daftplugAdminButton.-submit').each(function(e) {
    ...
    // Handle tooltips
    daftplugAdminMetabox.on('mouseenter mouseleave', '[data-tooltip]', function(e) {
        var self = jQuery(this);
    ...
    // Handle popup
    daftplugAdminMetabox.find('.daftplugAdminPopup').each(function(e) {
        var self = jQuery(this);
        var openPopup = self.attr('data-popup');
        var popupContainer = self.find('.daftplugAdminPopup_container');

        daftplugAdminMetabox.on('click', '[data-open-popup="'+openPopup+'"]', function(e) {
    ...
    daftplugAdminMetabox.find('.daftplugAdminInputText, .daftplugAdminInputNumber, .daftplugAdminInputTextarea, .daftplugAdminInputColor').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle text input
    daftplugAdminMetabox.find('.daftplugAdminInputText').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle textarea
    daftplugAdminMetabox.find('.daftplugAdminInputTextarea').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle checkbox
    daftplugAdminMetabox.find('.daftplugAdminInputCheckbox').each(function(e) {
        var self = jQuery(this);
        var field = self.find('.daftplugAdminInputCheckbox_field');
        var dependentDisableD = daftplugAdminMetabox.find('.-' + field.attr('id') + 'DependentDisableD');
        var dependentHideD = daftplugAdminMetabox.find('.-' + field.attr('id') + 'DependentHideD');
        var dependentDisableE = daftplugAdminMetabox.find('.-' + field.attr('id') + 'DependentDisableE');
        var dependentHideE = daftplugAdminMetabox.find('.-' + field.attr('id') + 'DependentHideE');
    ...
    // Handle number input
    daftplugAdminMetabox.find('.daftplugAdminInputNumber').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle select input
    daftplugAdminMetabox.find('.daftplugAdminInputSelect').each(function(e) {
        var self = jQuery(this);
        ...
        if (field.is('[multiple]')) {
	        ...
	        dropdown.add(label).on('click', function(e) {
                daftplugAdminMetabox.find('.daftplugAdminInputSelect_dropdown, .daftplugAdminInputSelect_list').not(dropdown).not(list).removeClass('-open');
	            e.stopPropagation();
	            e.preventDefault();
        ...
        jQuery(document).add(daftplugAdminMetabox.find('.daftplugAdminPopup_container')).on('click touch', function(e) {
    ...
    // Handle range input
    daftplugAdminMetabox.find('.daftplugAdminInputRange').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle color input
    daftplugAdminMetabox.find('.daftplugAdminInputColor').each(function(e) {
        var self = jQuery(this);
    ...
    // Handle upload input
    daftplugAdminMetabox.find('.daftplugAdminInputUpload').each(function(e) {
        var self = jQuery(this);
